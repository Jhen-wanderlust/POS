...
def setUp():
    ...
    while x <= 6:
        ...
        time.sleep(1)
        driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-tables-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('Table ' + str(x-1))
        time.sleep(1)
        ...
        driver.find_element_by_xpath('/html/body/ion-app/ion-popover/div/div[2]/div/ng-component/ion-list/ion-item/div[1]/ion-radio/button/span').click()
        time.sleep(1)
        driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-tables-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[3]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys(x)
        time.sleep(1)
