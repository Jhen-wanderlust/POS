...
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[1]/ion-list/ion-item[3]/div[1]/div/ion-label/ion-row/ion-col[5]/button/div[1]/div').click()
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[1]/ion-list/ion-item[3]/div[1]/div/ion-label/ion-row/ion-col[5]/button/div[1]/div').click()
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[1]/ion-list/ion-item[4]/div[1]/div/ion-label/ion-row/ion-col[1]/button/div[1]/div').click()
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[1]/ion-list/ion-item[4]/div[1]/div/ion-label/ion-row/ion-col[1]/button/div[1]/div').click()
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[1]/ion-list/ion-item[4]/div[1]/div/ion-label/ion-row/ion-col[1]/button/div[1]/div').click()
...
while i < int(length):
    ...
    if items[i].get_attribute('innerText') == "SODA":
        soda += 1 
    if items[i].get_attribute('innerText') == "POTATO FRIES":
        potatoFries += 1   
...
time.sleep(1)
vatable_sales = float(sum(total)) / 1.12
vat_amount = float(sum(total)) - vatable_sales
...
pymsgbox.alert('Vatable Sales: ' + str(round(vatable_sales,2)) + '\n' + 'Vat Amount: ' + str(round(vat_amount,2)) + '\n' + 'POS Vatable Sales: ' + pos_vatable_sales + '\n' + 'POS Vat Amount: ' + pos_vat_amount, timeout=5000)
...
if vat_amount == float(pos_vat_amount) or round(vat_amount,2) == float(pos_vat_amount):
    pymsgbox.alert("Vatable Amount Match ✅",timeout=5000)
else:
