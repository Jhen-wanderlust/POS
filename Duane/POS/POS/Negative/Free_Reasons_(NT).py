...
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-free-reason/ion-header/ion-navbar/div[2]/ion-searchbar/div/input').send_keys('x')
time.sleep(1)
pymsgbox.alert('SEARCH NOT EXISTING DATA: NO RESULT: ✅',timeout=3000)
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-free-reason/ion-header/ion-navbar/div[2]/ion-searchbar/div/input').send_keys(Keys.BACKSPACE)
time.sleep(1)
...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-free-reason-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[2]/ion-col/button[2]').click()
time.sleep(1)
pymsgbox.alert('CANT ADD DATA WITH EMPTY VALUE: ✅',timeout=3000)
time.sleep(1)


driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-free-reason-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('Reason 1')
time.sleep(1)
