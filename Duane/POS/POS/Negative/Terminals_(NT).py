...
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-terminal/ion-header/ion-navbar/div[2]/ion-searchbar/div/input').send_keys('x')
time.sleep(1)
...
time.sleep(1)
terminal = driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-terminal-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').get_attribute('value')
time.sleep(1)
...
if len(terminal) <= 0:
    pymsgbox.alert('CANT ADD TERMINAL IF THERE IS EMPTY FILEDS: ✅',timeout=3000)

time.sleep(1)
pymsgbox.alert('SEARCH NOT EXISTING DATA: NO RESULT: ✅\nCANT ADD TERMINAL IF THERE IS EMPTY FILEDS: ✅')
