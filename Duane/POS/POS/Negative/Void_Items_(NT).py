...
if user != 'lstv' or pw != 'lstventures':
    pymsgbox.alert('CANT VOID ITEM IF USER CODE OR PASSWORD IS INCORRECT ✅',timeout=3000)
...
time.sleep(1)
if len(reason) <= 0:
    pymsgbox.alert('CANT VOID ITEM IF THERE IS NO REASAON ✅',timeout=3000)

time.sleep(1)
pymsgbox.alert('CANT VOID ITEM IF USER CODE OR PASSWORD IS INCORRECT ✅\nCANT VOID ITEM IF THERE IS NO REASAON ✅')
