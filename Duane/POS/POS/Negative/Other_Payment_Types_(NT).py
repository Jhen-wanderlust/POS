...
time.sleep(1)
pymsgbox.alert('CANT ADD DATA IF OTHER PAYMENT TYPE IS EMPTY: ✅',timeout=3000,)
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-payment-type-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('OPT')
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-payment-type-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[2]/ion-col/button[2]/span').click()
time.sleep(1)
pymsgbox.alert('CANT ADD DUPLICATE DATA ✅',timeout=3000,)
time.sleep(1)
pymsgbox.alert('CANT ADD DATA IF OTHER PAYMENT TYPE IS EMPTY: ✅\nCANT ADD DUPLICATE DATA ✅')