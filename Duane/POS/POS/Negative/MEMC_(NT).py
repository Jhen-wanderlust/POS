...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-memc/ion-header/ion-navbar/div[2]/ion-searchbar/div/input').send_keys('x')
time.sleep(1)
pymsgbox.alert('SEARCH NOT EXISTING DATA: NO RESULT: ✅',timeout=3000)
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-memc/ion-header/ion-navbar/div[2]/ion-searchbar/div/input').send_keys(Keys.BACKSPACE)
time.sleep(1)
...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-memc-crud/ion-content/div[2]/form/ion-card/ion-col/ion-row/button[2]').click()
time.sleep(1)
pymsgbox.alert('CANT ADD DATA WITH EMPTY VALUE: ✅',timeout=3000)
time.sleep(1)
...
time.sleep(1)
pymsgbox.alert('NEED TO FILL ALL FIELDS BEFORE ADDING DATA: ✅',timeout=3000)
time.sleep(1)
...
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-memc-crud/ion-content/div[2]/form/ion-card/ion-col/ion-row/button[2]/span').click()
time.sleep(1)
pymsgbox.alert('CANT ADD DUPLICATE DATA: ✅',timeout=3000)
time.sleep(1)

pymsgbox.alert('SEARCH NOT EXISTING DATA: NO RESULT: ✅\nCANT ADD DATA WITH EMPTY VALUE: ✅\nNEED TO FILL ALL FIELDS BEFORE ADDING DATA ✅\nCANT ADD DUPLICATE DATA: ✅')