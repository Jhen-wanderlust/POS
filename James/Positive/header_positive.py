...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-header-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[6]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('Manila,Philippines')
time.sleep(1)
...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-header-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[7]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('San Fernando Pampanga')
time.sleep(1)
...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-header-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[8]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('Lubao Pampanga')
time.sleep(1)
...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-header-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[9]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('1111111')
time.sleep(1)
...
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-masterfiles/ion-content/div[2]/ion-grid/ion-row/ion-col/ion-item[1]/div[1]/div/ion-label')
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-header-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[11]/ion-col/button[1]/span').click()
time.sleep(1)
