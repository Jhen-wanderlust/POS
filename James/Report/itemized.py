...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-report-option/ion-content/div[2]/form/ion-grid/ion-card[2]/ion-row[3]/ion-col[1]/ion-item/div[1]/div/ion-datetime/button/span').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-picker-cmp/div/div[1]/div[2]/button/span').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-report-option/ion-content/div[2]/form/ion-grid/ion-card[2]/ion-row[3]/ion-col[2]/ion-item/div[1]/div/ion-datetime/button/span').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-picker-cmp/div/div[1]/div[2]/button/span').click()
time.sleep(1)
...
#Total # of Quantity
file = open("C:/Users/SERAN/Downloads/i.csv")
tq_value = (file.readlines())[28]
tq_val1 = tq_value[14:16]
print(tq_val1)
...
if int(tq_val1) == int(tq_val2):
    print("TOTAL NUMBER OF PAX  IN SCENARIO 5 MATCHED IN ITEMIZED REPORT")
    time.sleep(2)
else:
    print("TOTAL NUMBER OF PAX  IN SCENARIO 5 DO NOT MATCH IN ITEMIZED REPORT")
    time.sleep(2)

#Total AMOUNT OF FOOODS
file = open("C:/Users/SERAN/Downloads/i.csv")
ta_value = (file.readlines())[28]
ta_val1 = ta_value[18:25]
print(ta_val1)
...
if float(ta_val1) == float(ta_val2):
    print("TOTAL AMOUNT OF FOODS IN SCENARIO 5 MATCHED IN ITEMIZED REPORT")
    time.sleep(2)
else:
    print("TOTAL AMOUNT OF FOODS IN SCENARIO 5 DO NOT MATCH IN ITEMIZED REPORT")
    time.sleep(2)

#Less VAT Adj
file = open("C:/Users/SERAN/Downloads/i.csv")
vat_value = (file.readlines())[28]
vat_val1 = vat_value[27:31]
print(vat_val1)
...
if float(vat_val1) == float(vat_val2):
    print("LESS VAT ADJ  IN SCENARIO 5 MATCHED IN ITEMIZED REPORT")
    time.sleep(2)
else:
    print("LESS VAT ADJ  IN SCENARIO 5 DO NOT MATCH IN ITEMIZED REPORT")
    time.sleep(2)

#LESS DISCOUNTS
file = open("C:/Users/SERAN/Downloads/i.csv")
ld_value = (file.readlines())[28]
ld_val1 = ld_value[33:39]
print(ld_val1)
...
if float(ld_val1) == float(ld_val2):
    print("DISCOUNT IN SCENARIO 5 MATCHED IN ITEMIZED REPORT")
    time.sleep(2)
else:
    print("DISCOUNT IN SCENARIO 5 DO NOT MATCH IN ITEMIZED REPORT")
    time.sleep(2)
...
if float(ld_val1) == float(ld_val3):
    print("TOTAL AMOUNT WITH DISCOUNT IN SCENARIO 5 MATCHED IN ITEMIZED REPORT")
    time.sleep(2)
else:
    print("TOTAL AMOUNT WITH DISCOUNT IN SCENARIO 5 DO NOT MATCH IN ITEMIZED REPORT")
    time.sleep(2)
