...
subtotal = float(caldereta) + float (sisig) + float (nilaga)
...
time.sleep(1)
sc = 0.10
vatable = float (caldereta) / 1.12 * reg_dsc
...
driver.execute_script('alert("ITEM 8 COMPUTATION IN SCENARIO 5 PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4) 
