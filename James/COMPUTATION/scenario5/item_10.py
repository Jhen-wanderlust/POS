...
time.sleep(1)
sc = 0.10
vatable = float (sinigang) / 1.12 * reg_dsc
...
srvc_chrg2 =(np.round(srvc_chrg, 2))

if float(sc_total) == srvc_chrg2:
...
if float (final_amount) == total2:
    ...
    driver.switch_to.alert.accept() 
    time.sleep(4) 
print('total amount computation',total2)
print('total amount computation',final_amount)  

driver.execute_script('alert("ITEM 10 COMPUTATION IN SCENARIO 5 PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4) 
