...
#price
burgersteak = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[5]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
extrarice = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[6]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
...
print('price',burgersteak)
print('price',extrarice)
print('price',nilaga)
print('price',soda)
print('price',st)

#subtotal computation
subtotal =  float (burgersteak) + float (extrarice) + float (nilaga) + float (soda)
...
time.sleep(1)
sc = 0.10
vatable = (float (burgersteak ) + float (extrarice) + float (soda)) / 1.12 * reg_dsc
...
driver.execute_script('alert("ITEM 4 COMPUTATION IN SCENARIO 5 PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4) 
