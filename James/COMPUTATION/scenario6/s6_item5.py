...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-alert/div/div[3]/div/button[4]/span/div[1]').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-alert/div/div[4]/button[2]/span').click()
time.sleep(1)
...
#price
fish_fillet = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[5]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
fried_chicken = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[6]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
nilaga = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[7]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
soda = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[8]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
...
print('price',fried_chicken)
print('price',nilaga)
print('price',st)

#subtotal computation
subtotal =  float (fish_fillet) + float (fried_chicken) + float (nilaga) + float (soda)
...
reg_dsc = 0.20
regular = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[12]/h4[2]').get_attribute('innerText')
time.sleep(1)
regular1 = regular[2:]
reg = float(st) * reg_dsc
if reg == float(regular1):
    driver.execute_script('alert("DISCOUNT COMPUTATION MATCHED AND APPLIED✅ ");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else:
    driver.execute_script('alert("DISCOUNT COMPUTATION DOES NOT MATCH AND APPLY❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)  
print('discount computation',reg)
print('discount computation',regular1)

#service charge computation/
sc_total = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[13]/h4[2]').get_attribute('innerText')
time.sleep(1)
sc = 0.10
vatable = (float (fried_chicken )+ float (fish_fillet) + float (soda))/ 1.12 * sc
string_vat1 = (np.round(vatable, 2))

#vat exempt computation
vat_exempt = (float(nilaga) ) * sc

srvc_chrg= float(string_vat1)+ vat_exempt

if float(sc_total) == srvc_chrg:
    driver.execute_script('alert("SERVICE CHARGE MATCHED AND APPLIED✅ ");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else:
    driver.execute_script('alert("SERVICE CHARGE DOES NOT MATCH AND APPLY❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4) 
print('vat exempt computation',sc_total)
print('vat exempt computation',srvc_chrg) 
    
#total amount computation
total_amount = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[14]/h4[2]').get_attribute('innerText')
time.sleep(1)
total_disc = reg - srvc_chrg

total1 = float(st) - total_disc
total2 = (np.round(total1, 2))
if float (total_amount) == total2:
    driver.execute_script('alert("TOTAL AMOUNT COMPUTATION MATCHED ✅ ");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else:
    driver.execute_script('alert("TOTAL AMOUNT DOES NOT MATCH ❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4) 
print('total amount computation',total1)
print('total amount computation',total_amount)  

driver.execute_script('alert("ITEM 5 COMPUTATION IN SCENARIO 6 PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4) 
