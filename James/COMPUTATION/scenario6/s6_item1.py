...
subtotal = float(adobo) + float (sinigang) + float (nilaga)
...
string_vat = str(vatable)
string_vat1 =string_vat[0:5]
...
driver.execute_script('alert("ITEM 1 COMPUTATION IN SCENARIO 6 PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4) 
