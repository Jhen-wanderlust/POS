...
#price
sinigang = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[5]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
sisig = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[6]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
...
subtotal =  float (sinigang) + float (sisig) + float ( nilaga)
...
time.sleep(1)
sc = 0.10
vatable = float (sinigang )  / 1.12 * sc
string_vat1 = (np.round(vatable, 2))

#vat exempt computation
vat_exempt = (float(nilaga) + float (sisig)) * sc
...
driver.execute_script('alert("ITEM 9 COMPUTATION IN SCENARIO 6 PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4) 
