...
#price
sisig = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[5]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
...
subtotal =  float (sisig) + float (nilaga)
...
print('vat exempt computation',vat_exempt) 
...
driver.execute_script('alert("ITEM 10 COMPUTATION IN SCENARIO 6 PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4) 
