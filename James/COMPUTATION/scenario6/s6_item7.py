...
#price
caldereta = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[5]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
sinigang = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[6]/div/h4[2]').get_attribute('innerText')
time.sleep(1)
...
print('price',caldereta)
print('price',sinigang)
print('price',nilaga)
print('price',final_st)

#subtotal computation
subtotal =  float (caldereta) + float (sinigang) + float ( nilaga)
...
reg_dsc = 0.20
regular = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[11]/h4[2]').get_attribute('innerText')
time.sleep(1)
regular1 = regular[2:]
reg = float(final_st) * reg_dsc
...
sc_total = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[12]/h4[2]').get_attribute('innerText')
time.sleep(1)
sc = 0.10
vatable = (float (caldereta ) + float (sinigang)) / 1.12 * sc
...
total_amount = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[13]/h4[2]').get_attribute('innerText')
time.sleep(1)
total_amount1= total_amount.replace(",", "")
total_disc = reg - srvc_chrg

total1 = float(final_st) - total_disc
total2 = (np.round(total1, 2))
if float (total_amount1) == total2:
...
print('total amount computation',total_amount1)  

driver.execute_script('alert("ITEM 7 COMPUTATION IN SCENARIO 6 PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4) 
