...
#price
memc_combo_2 = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[5]/div[1]/h4[2]').get_attribute('innerText')
time.sleep(1)
memc_combo_4 = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[6]/div[1]/h4[2]').get_attribute('innerText')
time.sleep(1)
...
subtotal =   float (memc_combo_2)+ float (memc_combo_4)
...
time.sleep(1)
wo_vat1 =  float(memc_combo_2) + float (memc_combo_4)
...
time.sleep(1)
total2 = float(st) + float(service_charge) - float (less_vat) - float(sen2)
...
driver.execute_script('alert("ITEM 5 IN SCENARIO 7 & 8 PASSED!✅ ");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4)
