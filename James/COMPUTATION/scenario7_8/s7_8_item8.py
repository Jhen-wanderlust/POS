...
driver.find_element_by_xpath('/html/body/ion-app/ion-alert/div/div[4]/button[2]/span').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[1]/ion-list/ion-item[2]/div[1]/div/ion-label/ion-row/ion-col[4]/button/div[1]/div').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/combo-picker/ion-content/div[2]/ion-scroll/div/div/ion-toolbar/div[2]/button/span').click()
time.sleep(1)
...
driver.find_element_by_xpath('/html/body/ion-app/ion-alert/div/div[4]/button[2]/span').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[1]/ion-list/ion-item[2]/div[1]/div/ion-label/ion-row/ion-col[6]/button/div[1]/div').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/combo-picker/ion-content/div[2]/ion-scroll/div/div/ion-toolbar/div[2]/button/span').click()
time.sleep(1)
...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-alert/div/div[3]/div/div[2]/input').send_keys('3')
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-alert/div/div[4]/button[2]/span').click()
time.sleep(1)
...
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[2]/ion-content/div[2]/ion-list[1]/ion-list[9]/div/ion-item-sliding/ion-item/div[1]/div/ion-label/button/h2[2]').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-action-sheet/div/div/div[1]/button[5]/span').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-alert/div/div[3]/div/div[2]/input').send_keys('3')
...
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-ordering/ion-content/div[2]/div/div[2]/ion-content/div[2]/ion-list[1]/ion-list[12]/div/ion-item-sliding/ion-item/div[1]/div/ion-label/button/h2[2]').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-action-sheet/div/div/div[1]/button[5]/span').click()
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-alert/div/div[3]/div/div[2]/input').send_keys('3')
...
time.sleep(1)
memc_combo_2 = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[7]/div[1]/h4[2]').get_attribute('innerText')
time.sleep(1)
memc_combo_3 = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[6]/div[1]/h4[2]').get_attribute('innerText')
time.sleep(1)
memc_combo_4 = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[8]/div[1]/h4[2]').get_attribute('innerText')
time.sleep(1)
st = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[9]/h4[2]').get_attribute('innerText')
time.sleep(1)
final_st= (st.replace(",",""))

print('price',memc_combo_1)
print('price',memc_combo_2)
print('price',memc_combo_3)
print('price',memc_combo_4)
print('price',final_st)

#subtotal computation
subtotal =  float (memc_combo_1) + float (memc_combo_2)+ float (memc_combo_3) + float(memc_combo_4)
if float(final_st) == subtotal:
    ...
    driver.switch_to.alert.accept() 
    time.sleep(4)
print('subtotal computation',final_st)
...
memc = 100
vat_adj= 100/1.12
less_vat = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[10]/h4[2]').get_attribute('innerText')
time.sleep(1)
...
wo_vat = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[11]/h4[2]').get_attribute('innerText')
time.sleep(1)
final_vat = (wo_vat.replace(",",""))
wo_vat1 = vat_adj + float(memc_combo_2)+ float(memc_combo_4)
wo_vat2 = (np.round(wo_vat1, 2))
if float(final_vat) == wo_vat2:
    ...
    driver.switch_to.alert.accept() 
    time.sleep(4)
print('SALES WITHOUT VAT computation',final_vat)
...
sen= driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[12]/h4[2]').get_attribute('innerText')
time.sleep(1)
sen2 = sen[2:]
...
sc_disc= driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[13]/h4[2]').get_attribute('innerText')
time.sleep(1)
sc= 0.10
...
service_charge = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[14]/h4[2]').get_attribute('innerText')
time.sleep(1)
vat_item = (float(memc_combo_1) + float(memc_combo_3))/1.12*sc
vat_exempt = (float(memc_combo_2) + float(memc_combo_4)) * sc
summation= vat_item + vat_exempt
summation2 = summation - float (sc_disc1)
...
total = driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-order-preview/ion-content/div[2]/div/div[2]/div/div[15]/h4[2]').get_attribute('innerText')
time.sleep(1)
final_total = (total.replace(",",""))
total2 = float(final_st) + float(service_charge) - float (less_vat1) - float(sen2)
total3 = (np.round(total2,2))
if float(final_total) == total3:
    ...
    driver.switch_to.alert.accept() 
    time.sleep(4)
print('TOTAL computation',final_total)
print('TOTAL computation',total3)

driver.execute_script('alert("ITEM 7 IN SCENARIO 7 & 8 PASSED!✅ ");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4)