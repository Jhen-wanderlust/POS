...
vat_item2 = (np.round(vat_item,2))
vat_exempt = (float(memc_combo_2 )+ float (memc_combo_4)) * sc 
summation= vat_item2 + vat_exempt
summation2 = summation - float (sc_disc)

if float(service_charge) == summation2:
...
print('SERVICE CHARGE  computation',summation2)
...
driver.execute_script('alert("ITEM 4 IN SCENARIO 7 & 8 PASSED!✅ ");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4)
