...
time.sleep(1)
sc = 0.10
vatable = (float (adobo ) + float (sinigang)) / 1.12 * reg_dsc
...
if float (total_amount) == total1:
    ...
    driver.execute_script('alert("TOTAL AMOUNT DOES NOT MATCH AND APPLY❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4) 

driver.execute_script('alert("ITEM 1 COMPUTATION IN SCENARIO 5 PASSED✅");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4) 
