...
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-discount-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ')
time.sleep(1)
dd = driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-discount-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').get_attribute('value')
time.sleep(1)
if len (dd) >= 40:
    driver.execute_script('alert("CHARACTERS MUST NOT GREATER THAN 40❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else:
