...
time.sleep(1)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-void-reason-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ')
time.sleep(1)
text= driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-void-reason-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').get_attribute('value')
time.sleep(1)
