...
a = driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-area-code-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').get_attribute('value')
time.sleep(1)
...
time.sleep(1)
if len (a) == 0:
    driver.execute_script('alert("CANT ADD DATA IF FIELD IS EMPTY✅");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else: 
