...
time.sleep(1)
dc = driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-discount-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').get_attribute('value')
time.sleep(1)

if len (dc)== 0:
    driver.execute_script('alert("CANT ADD DATA IF DISCOUNT CODE IS EMPTY❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)

dd = driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-discount-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[2]/ion-col/ion-item/div[1]/div/ion-input/input').get_attribute('value')
time.sleep(1)
if len (dd)== 0:
    driver.execute_script('alert("CANT ADD DATA IF DISCOUNT DESCRIPTION IS EMPTY❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)

type= driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-discount-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[3]/ion-col/ion-item/div[1]/div/ion-select/button/span').get_attribute('value')
time.sleep(1)
if len (dd)== 0:
    driver.execute_script('alert("CANT ADD DATA IF TYPE IS EMPTY❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
driver.execute_script('alert("PLEASE FILL ALL FIELDS");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4)
