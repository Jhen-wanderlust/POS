...
tn =driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-tables-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').get_attribute('value')
time.sleep(1)
if len(tn) == 0:
    driver.execute_script('alert("TABLE NAME MUST FILL!❌ ");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else:
    ...
    driver.switch_to.alert.accept() 
    time.sleep(4)
area= driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-tables-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[2]/ion-col/ion-item/div[1]/div/ion-select/button').get_attribute('value')
if len(area) == 0:
    driver.execute_script('alert("AREA MUST FILL!❌ ");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else:
    ...
    driver.switch_to.alert.accept() 
    time.sleep(4)
sc = driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-tables-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[3]/ion-col/ion-item/div[1]/div/ion-input/input').get_attribute('value')
if len(area) == 0:
    driver.execute_script('alert("SEAT CAPACITY MUST FILL!❌");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else:
    ...
    driver.switch_to.alert.accept() 
    time.sleep(4)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-tables-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[6]/ion-col/button[1]/span').click()
time.sleep(1)
d = 0
for drinks in range (d,2):
    driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-tables/ion-content/div[1]/ion-fab/button').click()
    time.sleep(1)
...
driver.execute_script('alert("DUPLICATE ENTRY:PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4)
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-tables-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[6]/ion-col/button[1]/span').click()
...
driver.find_element_by_xpath('/html/body/ion-app/ng-component/ion-split-pane/ion-nav/page-tables/ion-header/ion-navbar/div[2]/ion-searchbar/div/input').send_keys('abcd')
time.sleep(1)
driver.execute_script('alert("NEGATIVE SEARCH TEST:PASSED✅");')
time.sleep(4)
driver.switch_to.alert.accept() 
time.sleep(4)
