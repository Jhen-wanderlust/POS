...
driver.find_element_by_xpath('/html/body/ion-app/ion-modal/div/page-tables-crud/ion-content/div[2]/form/ion-card/ion-grid/ion-row[1]/ion-col/ion-item/div[1]/div/ion-input/input').send_keys('QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ')
time.sleep(1)
...
time.sleep(1)
if len (tn) <= 40:
    driver.execute_script('alert("CHARACTERS MUST NOT ACCEPT 40 CHARACTERS❌ ");')
    time.sleep(4)
    driver.switch_to.alert.accept() 
    time.sleep(4)
else:
